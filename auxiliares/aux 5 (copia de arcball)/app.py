...
if __name__ == "__main__":
    ...
    def on_draw():
        ...
        # pipeline["light_position"] = (5.0*np.cos(time()/2), 5.0*np.sin(time()/2), -10.0)
        
        pipeline["light_position_1"] = (5.0*np.cos(time()/2), 5.0*np.sin(time()/2), -10.0)

        pipeline["Kd_1"] = (1.0, 0.0, 0.0)
        pipeline["Ld_1"] = (1.0, 0.0, 0.0)

        pipeline["light_position_2"] = (-5.0*np.cos(time()/2), -5.0*np.sin(time()/2), -10.0)

        pipeline["Kd_2"] = (0.0, 1.0, 0.0)
        pipeline["Ld_2"] = (0.0, 1.0, 0.0)
